    const defaultConfig = {
      ...
      company_name: "ElectroFix Pro",
      tagline: "Expert Appliance Repair & Genuine Parts",
      hero_title: "AC, Refrigerator, Geyser & Washing Machine Repair in Lucknow",
      hero_subtitle: "Fast, Reliable, Professional Service at Your Doorstep",
      cta_button_text: "Book Service Now",
      contact_phone: "8188856669",
      contact_email: "zk870953@gmail.com",
      contact_address: "Telibagh near Dental Hospital, Lucknow, Uttar Pradesh",
    ...
    const services = [
      {
        ...
        description: "Expert AC repair service in Lucknow including installation and maintenance for all brands",
        features: ["Gas Refilling", "Cleaning", "Installation", "Annual Maintenance"]
      },
      {
        icon: "🧊",
        name: "Refrigerator Repair",
        description: "Complete fridge repair services in Lucknow including cooling issues and compressor replacement",
        features: ["Cooling Issues", "Compressor Repair", "Door Seals", "Thermostat Fix"]
      },
      {
        icon: "🔥",
        name: "Geyser Repair",
        description: "Fast and reliable water heater repair and installation services in Lucknow",
        features: ["Element Replacement", "Thermostat Fix", "Leak Repair", "New Installation"]
      },
      {
        icon: "🌀",
        name: "Washing Machine Repair",
        description: "Professional repair services in Lucknow for all types of washing machines",
        features: ["Drum Issues", "Motor Repair", "Water Leaks", "Program Errors"]
      }
    ];
    ...
    function renderHomePage() {
      ...
      return `
        <div class="w-full">
          <!-- Hero Section -->
          <section class="w-full py-20 px-4" style="background: linear-gradient(135deg, ${config.primary_action_color}15 0%, ${config.surface_color} 100%);">
  ...
  style="background-color: ${config.primary_action_color}; color: ${config.surface_color}; font-family: ${config.font_family}, system-ui, sans-serif; font-size: ${config.font_size * 1.125}px">
          ...
          <section class="w-full py-16 px-4" style="background-color: ${config.background_color}">
            <div class="max-w-7xl mx-auto">
              ...
              <p class="text-center mb-12" style="color: ${config.text_color}; font-family: ${config.font_family}, system-ui, sans-serif; font-size: ${config.font_size}px">Professional repair services for all your home appliances</p>
        ...
        <div class="w-full">
          <section class="w-full py-16 px-4" style="background: linear-gradient(135deg, ${config.primary_action_color}15 0%, ${config.background_color} 100%);">
            <div class="max-w-5xl mx-auto">
              ...
              <p class="text-center text-xl mb-12" style="color: ${config.text_color}; font-family: ${config.font_family}, system-ui, sans-serif; font-size: ${config.font_size * 1.25}px">Get in touch for service bookings or inquiries</p>
